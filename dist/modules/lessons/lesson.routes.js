...
router.post('/options/programs', authorize(['lessons.create']), authorizeFields('lessons', (req) => Object.keys(req.body || {})), lesson_controller_1.default.createProgram);
router.get('/course-mappings', authorize(['lessons.view']), lesson_controller_1.default.courseMappings);
router.put('/course-mappings', authorize(['lessons.update']), lesson_controller_1.default.updateCourseMappings);
