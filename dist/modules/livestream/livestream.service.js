...
exports.updateBulk = exports.getCalendar = exports.cancelSession = exports.updateSchedule = exports.createBulk = exports.createSingle = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
// Helper: Tạo key (sessionId) tự động theo quy tắc
const generateKey = (systemType, startTime, code, lessonCount) => {
...
const checkConflict = async ({ teacher, start_time, end_time, id }) => {
    if (teacher) {
        ...
        try {
            ...
            return await prisma.$transaction(async (tx) => {
                ...
                for (let i = 0; i < followings.length; i++) {
                    ...
                    const updateData = {};
                    syllabusFields.forEach(field => {
                        updateData[field] = sourceSyllabus[field];
                    });
                ...
                if (data.new_session) {
                    ...
                    syllabusFields.forEach(field => {
                        newSessionData[field] = lastSyllabus[field];
                    });
                    ...
                    if (newSessionData.teacher) {
                        ...
                        if (conflictTeacher)
                            throw new Error("Trùng lịch giáo viên ở buổi học bổ sung");
                    }
                    // Sinh KEY cho buổi mới
                    newSessionData.key = generateKey(newSessionData.system_type || 'topclass', newSessionData.start_time, newSessionData.code, newSessionData.lesson_count || 0);
