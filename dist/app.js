...
const room_config_1 = require("./modules/room-config");
const program_teacher_banners_1 = require("./modules/program-teacher-banners");
...
app.use("/api/program-teacher-banners", program_teacher_banners_1.programTeacherBannerRoutes);
