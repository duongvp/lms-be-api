...
const validateLessonListQuery = (query) => {
    ...
    if ([learnNumber, fromLearnNumber, toLearnNumber].some((value) => value !== undefined && value <= 0)) {
        throw new ApiError_1.default('Khoảng bài phải lớn hơn 0', 400);
    }
    if (fromLearnNumber !== undefined && toLearnNumber !== undefined
        && fromLearnNumber > toLearnNumber) {
        throw new ApiError_1.default('Khoảng bài không hợp lệ', 400);
    }
    return {
        page,
        limit,
...
const validateLessonReorderPayload = (body) => {
    ...
    if (body.renumber !== undefined && typeof body.renumber !== 'boolean') {
        throw new ApiError_1.default('renumber phải là boolean', 400);
    }
    return {
        grade,
        subject_code: subjectCode,
