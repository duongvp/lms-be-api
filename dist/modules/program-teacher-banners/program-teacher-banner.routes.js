...
const controller = __importStar(require("./program-teacher-banner.controller"));
...
router.post('/', auth_middleware_1.default.authorize(['program_teacher_banner.create']), controller.create);
router.put('/:id', auth_middleware_1.default.authorize(['program_teacher_banner.update']), controller.update);
router.delete('/:id', auth_middleware_1.default.authorize(['program_teacher_banner.delete']), controller.remove);
