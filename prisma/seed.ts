...
async function main() {
  ...
  const moduleFieldsData = [
    ...
    { moduleCode: 'lessons', fieldCode: 'evg_banner', fieldLabel: 'Banner', fieldType: 'text', sortOrder: 7 },
    { moduleCode: 'lessons', fieldCode: 'evg_stream', fieldLabel: 'EVG Stream', fieldType: 'text', sortOrder: 8 },
    { moduleCode: 'lessons', fieldCode: 'lesson_link', fieldLabel: 'Link bài học', fieldType: 'text', sortOrder: 9 },
    { moduleCode: 'lessons', fieldCode: 'lesson_baitap', fieldLabel: 'Bài tập', fieldType: 'textarea', sortOrder: 10 },
    { moduleCode: 'lessons', fieldCode: 'lesson_tomtat', fieldLabel: 'Tóm tắt', fieldType: 'textarea', sortOrder: 11 },
    { moduleCode: 'lessons', fieldCode: 'lesson_phuongphap', fieldLabel: 'Phương pháp', fieldType: 'textarea', sortOrder: 12 },
    { moduleCode: 'lessons', fieldCode: 'lesson_luuy', fieldLabel: 'Lưu ý', fieldType: 'textarea', sortOrder: 13 },
    { moduleCode: 'lessons', fieldCode: 'lesson_ketqua', fieldLabel: 'Kết quả', fieldType: 'textarea', sortOrder: 14 },
    { moduleCode: 'lessons', fieldCode: 'status', fieldLabel: 'Trạng thái', fieldType: 'number', sortOrder: 15 },
    { moduleCode: 'lessons', fieldCode: 'created_at', fieldLabel: 'Ngày tạo', fieldType: 'datetime', sortOrder: 16 },
    { moduleCode: 'lessons', fieldCode: 'updated_at', fieldLabel: 'Ngày cập nhật', fieldType: 'datetime', sortOrder: 17 },
