...
router.post('/options/programs', authorize(['lessons.create']), authorizeProgram('lessons.create', (req) => String(req.body?.subject_code || '')), authorizeFields('lessons', (req) => Object.keys(req.body || {})), lesson_controller_1.default.createProgram);
...
router.patch('/bulk', authorize(['lessons.update']), authorizePrograms('lessons.update', (req) => lessonCodesByIds(req.body?.ids || [])), authorizeFields('lessons', (req) => Object.keys(req.body?.data || {})), lesson_controller_1.default.bulkUpdate);
...
router.post('/import', authorize(['lessons.import']), upload.single('file'), authorizeProgram('lessons.import', (req) => String(req.body?.program_code || '')), lesson_controller_1.default.importFile);
...
router.post('/', authorize(['lessons.create']), authorizeProgram('lessons.create', (req) => String(req.body?.subject_code || '')), authorizeFields('lessons', (req) => Object.keys(req.body || {})), lesson_controller_1.default.create);
router.put('/:id', authorize(['lessons.update']), authorizePrograms('lessons.update', (req) => lessonCodesByIds([req.params.id])), authorizeFields('lessons', (req) => Object.keys(req.body || {})), lesson_controller_1.default.update);
